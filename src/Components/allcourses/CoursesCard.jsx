              ...
              <div className="right">
                ...
                <div className="rating">
                  <input
                    ...
                    value="5"
                  />
                  <label htmlFor={`star5-${item.id}`} title="5 stars"></label>
                  ...
                  <input
                    ...
                    value="4"
                  />
                  <label htmlFor={`star4-${item.id}`} title="4 stars"></label>
                  ...
                  <input
                    ...
                    checked
                  />
                  <label htmlFor={`star3-${item.id}`} title="3 stars"></label>
                  ...
                  <input
                    ...
                    value="2"
                  />
                  <label htmlFor={`star2-${item.id}`} title="2 stars"></label>
                  ...
                  <input
                    ...
                    value="1"
                  />
                  <label htmlFor={`star1-${item.id}`} title="1 star"></label>
                </div>
